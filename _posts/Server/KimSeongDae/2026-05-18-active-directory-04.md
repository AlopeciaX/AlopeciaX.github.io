...
68 bind *:80
72 use_backend app
87 server app1 172.16.0.21:65080 check
88 server app2 172.16.0.22:65080 check
89 #
90 #
```
...
**모의침투**
	...
	metasploitable3 2008버전으로 실습 진행

1. Metasploitable3

	vegrant 패스워드 vagrant 똑같음
	ip 설정부터 ncpa.cpl
	ipv4 10.0.0.31/24 툴 설치x 오래된 버전쓰기
	start service: 취약점 중 하나

2. CentOS_3_WebServer

	부팅 시 e키 클릭
	밑으로 한칸 내려서 quiet -> single b눌러서 부팅
	passwd / It1 / reboot
	root / It1 로 로그인
...
**모의침투**
	...
	취약점 실습용 서버는 업데이트하지않으며 예전 그대로의 상태를 사용
	네트워크 연결 및 초기 설정 후 스냅샷 찍어두기

1. Metasploitable3_win2008

![](../../../assets/images/Security/KimSeongDae//2026-05-18-security_026/file-20260518232416018.png)
