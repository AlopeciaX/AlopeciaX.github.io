...
#3단계
docker run -itd -p 65080:80 -e WORDPRESS_DB_HOST=10.0.0.11 -e WORDPRESS_DB_USER=root -e WORDPRESS_DB_PASSWORD=It12345! -e WORDPRESS_DB_NAME=word --name w1 wordpress
```
