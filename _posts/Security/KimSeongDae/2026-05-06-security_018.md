...
![](../../../assets/images/Security/KimSeongDae/2026-05-06-security_018/file-20260506101103000.png)
...
## 설치 순서
	...
	dnf install -y bind bind-utils bind-libs
	vi /etc/named.conf -- 어떤 네트워크 카드로 서비스할 것인지(10.0.0.11로 설정해도됨(http))
	vi /etc/named.rfc1912.zones -- 정방향/역방향 조회 설정(보안때문에, 설정되지 않으면
	 unknown 이라 나옴), 정방향(23~27), 역방향(41~45)
	 주 영역이면 master, 보조 영역이면 slave
	 slave면 master를 가리켜야 함
...
보조영역이 있기 때문에 allow-update 허용해줘야 함
...
레코드값 업데이트는 주영역만 가능하다. 보조는 실시간으로 업데이트 된다.
...
![](../../../assets/images/Security/KimSeongDae/2026-05-06-security_018/file-20260506163214996.png)
...
![](../../../assets/images/Security/KimSeongDae/2026-05-06-security_018/file-20260506164816140.png)


가상머신 -> 짝꿍의 도메인 -> 짝꿍의 웹서버 접속
