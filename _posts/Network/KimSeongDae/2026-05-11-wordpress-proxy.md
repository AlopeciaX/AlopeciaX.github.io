...
firewall-cmd --permanent --add-port=3306/tcp
firewall-cmd --reload
mysql -uroot -e "create user 'jhjang'@'%' identified by 'It12345@'; grant all privileges on *.* to 'jhjang'@'%'; create database wordpress;"
```


haproxy는 reverse proxy이다.

haproxy로 loadbalancer 구현
67: jhjang
68: 80
서버 부분도 주소 바꾸고 2개니까 2개로
...
HAProxy : 팀장 rocky9-1
wordpress: 팀원1 rocky9-2
wordpress: 팀원2 rocky9-3
DB: 팀원 rocky9-4
