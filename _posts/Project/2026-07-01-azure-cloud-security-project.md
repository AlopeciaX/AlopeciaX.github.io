...
![](../../assets/images/_posts/Project/2026-07-01-azure-cloud-security-project/file-20260708151508718.png)

퇴사자 DB 계정으로는 빨간색 표시만큼의 작업밖에 수행 못함
...
```kql
AzureDiagnostics
| distinct Category, ResourceType
```

![](../../assets/images/_posts/Project/2026-07-01-azure-cloud-security-project/file-20260708151848602.png)
