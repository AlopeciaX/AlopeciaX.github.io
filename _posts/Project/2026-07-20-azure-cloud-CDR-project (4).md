...
*terraform apply 완료 로그 — `Apply complete! Resources: 7 added, 0 changed, 0 destroyed.` 및 output 값(공인 IP, MySQL FQDN 등)*

![](../../assets/images/Project/2026-07-20-azure-cloud-CDR-project/file-20260713174221677.png)
*`team604tuna05-infra` 리소스그룹 개요 — Key Vault, Storage Account 생성 확인*

![](../../assets/images/Project/2026-07-20-azure-cloud-CDR-project/file-20260713174653068.png)
*Bootstrap 스크립트 실행 결과 — Storage Account/Key Vault 생성 완료*
...
*WordPress 설치 정보 입력 화면 — 사이트 제목 `tunaWebPage`, 사용자명 `nova06`*
...
*`mysql.user` 조회 결과 — `AUTHENTICATION_STRING`이 VM Managed Identity Object ID와 일치 확인*

![](../../assets/images/Project/2026-07-20-azure-cloud-CDR-project/file-20260713181855055.png)
*WordPress 사이트 정상 접속 화면 (DB 연결 정상화 후)*
