...
> 🖼️ *사진 자리 — 보고서 7p, Windows 대상 Nmap 스캔 결과 화면*
...
> 🖼️ *사진 자리 — 보고서 9p, Linux 대상 Nmap 스캔 결과 화면*
...
> 🖼️ *사진 자리 — 보고서 12~13p, Nessus/OpenVAS 스캔 결과 요약 화면(위험도별 그래프)*
...
> 🖼️ *사진 자리 — 보고서 20~22p, 공격 우선순위 선정 표(Windows/Linux)*
